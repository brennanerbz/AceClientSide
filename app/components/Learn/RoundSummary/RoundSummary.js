				...
				<table className="summary_table">
					<tbody>
						<tr className="recall_row">
							...
							<td className="count">
								{(slots.filter(slot => slot.format == 'recall').length / slot_length) / 100 * 10000} % 
							</td>
						</tr>
						<tr className="mc_row">
							...
							<td className="count">
								{(slots.filter(slot => slot.format == 'mc').length / slot_length) / 100 * 10000}  %
							</td>
						</tr>
						<tr className="fb_row">
							...
							<td className="count">
								{(slots.filter(slot => slot.format == 'stem').length / slot_length) / 100 * 10000 } % 
							</td>
						</tr>
						<tr className="copy_row">
							...
							<td className="count">
								{(slots.filter(slot => slot.format == 'copy').length / slot_length) / 100 * 10000 } %  
							</td>
						</tr>
					</tbody>
				</table>
